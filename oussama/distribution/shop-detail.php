...
<html>
  ...
  <body>
              ...
              <div id="details" class="box mb-4 mt-4">
                ...
                <ul>
                  ...
                  <li>The model (height 5'8 "and chest 33") is wearing a size S</li>
                    ...
                    <form action="View/add_rate.php" method="post" id ="form">
                        ...
                        <div>
                            <h2>Liked our product ?feel Free to rate it! </h2>
                                ...
                                <div class="col-sm-6">
                                <div class="form-group">
                                    <label for="name" placeholder="Your name">Name <span class="required text-primary">*</span></label>
                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                <div class="form-group">
                                    <label for="email"placeholder="Your email">Email <span class="required text-primary">*</span></label>
                                    <span id ="errormail"></span>
                                    <input id="email" name="email" type="text" class="form-control" onkeydown="onkey()">
                                </div>
                                </div>
                            </div>
                            <div class="row">
                            <div class="col-sm-12">
                                <div class="form-group">
                                    <label for="comment "placeholder="Your review">Review<span class="required text-primary">*</span></label>
                                    <span id ="errorcmt"></span>

                                    <textarea id="comment" name="content" rows="4" class="form-control"></textarea>
                                </div>
                                </div>
                            </div>
                      ...
                      <button type="submit" class="btn btn-template-outlined"name="add" onclick="connect()"><i class="fa fa-comment-o"></i> Send</button>
                    </div>
    ...
    <!-- Javascript files-->
    <script src="js/CSreport.js"></script>
