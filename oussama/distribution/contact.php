          ...
          <section class="bar pt-0">
            <div class="row">
              ...
              <div class="col-md-8 mx-auto">
                <form action="controller/sms.php" method="POST">
                  <div class="row">
                    <div class="col-sm-6">
                      <div class="form-group">
                        <label for="firstname">number</label>
                        <input id="number" type="text" class="form-control" name="number" value="+216" placeholder="enter your phone number">
                      </div>
                    </div>                 
                    <div class="col-sm-12">
                      <div class="form-group">
                        <label for="message">Message</label>
                        <textarea id="text" class="form-control" placeholder="enter your message" name="text"></textarea>
                      </div>
                    </div>
