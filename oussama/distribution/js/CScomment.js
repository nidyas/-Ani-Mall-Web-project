...
{   var holdname=document.getElementById('name').value;
    ...
    var holdaddr=document.getElementById('addr').value;
    var holdcomment=document.getElementById('comment').value;
    if ((holdname.length==0) || (holdemail.length==0) || (holdaddr.length==0) || (holdcomment.length==0)   )
    {  
        ...
        let error2=document.getElementById('erroradr');
        error2.innerHTML="please fill the location ";
