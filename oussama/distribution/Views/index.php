    ...
    <div id="all">
        ...
        <div class="container">
          <div class="row d-flex align-items-center">
            <div class="col-md-6 d-md-block d-none">
              <p>Contact us on +126 56 123 458 or ani'mall@gmail.com.</p>
            </div>
            <div class="col-md-6">
              <div class="d-flex justify-content-md-end justify-content-between">
                ...
                <?php
                    ...
                    <div class="login">
                            <a href="afficher_user.php" class="signup-btn"><i class="fa fa-user"></i><span class="d-none d-md-inline-block"> <?php echo " ".$_SESSION['nom']; ?></span></a>
                            <a href="logout.php" class="login-btn"><i class="fa fa-sign-out"></i><span class="d-none d-md-inline-block">Se déconnecter</span></a>
                        </div>
                        <?php
                    }else {?>
                        <div class="login">
                            ...
                            <a href="inscription.php" class="signup-btn"><i class="fa fa-user"></i><span class="d-none d-md-inline-block">Sign Up</span></a>
                        </div>
                <?php    }
                ?>
            ...
            <div class="modal-body">
              <form action="connexion.php" method="POST">
                <div class="form-group">
                  <input id="mail" name="mail"  type="email" placeholder="mail" class="form-control">
                </div>
                <div class="form-group">
                  <input id="password" name="password" type="password" placeholder="Mot de passe" class="form-control">
                </div>
                <p class="text-center">
                  <button class="btn btn-template-outlined" type="Submit"><i class="fa fa-sign-in"></i> Se connecter</button>
                </p>
              </form>
              <p class="text-center text-muted">Not registered yet?</p>
              <p class="text-center text-muted"><a href="inscription.php"><strong>S'inscrire</strong></a>! It is easy and done in 1 minute and gives you access to special discounts and much more!</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <header class="nav-holder make-sticky">
        <div id="navbar" role="navigation" class="navbar navbar-expand-lg">
          <div class="container"><a href="index.html" class="navbar-brand home"><img src="img/logoo.png" alt="Universal logo" class="d-none d-md-inline-block"><img src="img/logo-small.png" alt="Universal logo" class="d-inline-block d-md-none"><span class="sr-only">Universal - go to homepage</span></a>
            ...
            <div id="navigation" class="navbar-collapse collapse">
              <ul class="nav navbar-nav ml-auto">
                    ...
                    <li>
                      <div class="row">
                        ...
                        <div class="col-md-6 col-lg-3">
                          <h5>Shop</h5>
                          <ul class="list-unstyled mb-3">
                            <li class="nav-item"><a href="../shop-category.php" class="nav-link">shop</a></li>
                         
                            <li class="nav-item"><a href="../shop-detail.php" class="nav-link">Product detail & rating</a></li>
                          </ul>
                        ...
                        <div class="col-md-6 col-lg-3">
                          ...
                          <h5>Pages</h5>
                          <ul class="list-unstyled mb-3">
                            <li class="nav-item"><a href="/webdev/views/form-wizard.php" class="nav-link">gestion veterinaire</a></li>
                            <li class="nav-item"><a href="/webdev/views/form-wizard2.php" class="nav-link">gestion dresseur</a></li>
                          ...
                          <h5>Blog</h5>
                          <ul class="list-unstyled mb-3">
                            <li class="nav-item"><a href="../blog-post.php" class="nav-link">Blog Post</a></li>
                          </ul>
                        </div>
                      </div>
                    </li>
                ...
                <li class="nav-item dropdown"><a href="javascript: void(0)" data-toggle="dropdown" class="dropdown-toggle">Contact <b class="caret"></b></a>
                  <ul class="dropdown-menu">
                    <li class="dropdown-item"><a href="../contact.php" class="nav-link">Contact  with phone</a></li>
                  </ul>
                </li>
      ...
      <section style="background: url(img/fixed-background-2.jpg) center top no-repeat; background-size: cover;" class="bar no-mb color-white text-center bg-fixed relative-positioned">
        ...
        <div class="container">
          ...
          <p class="lead">We have prepared for you the utopia for your pet.</p>
          <p class="text-center"><a href="index2.html" class="btn btn-template-outlined-white btn-lg">Click here</a></p>
        </div>
      </section>
        ...
        <div class="container">
          <div class="row">
            <div class="col-lg-8 text-center p-3">
              <h3>Do you want to bye pet-food?</h3>
            </div>
            <div class="col-lg-4 text-center p-3">   <a href="../shop-category.php" class="btn btn-template-outlined-white">Shop now</a></div>
          </div>
        </div>
      </div>
      <!-- FOOTER -->
        ...
        <div class="container">
          <div class="row">
            <div class="col-lg-3">
              ...
              <p>we made this website to make your pet happy.</p>
              <hr>
            ...
            <div class="col-lg-3">
              ...
              <ul class="list-unstyled footer-blog-list">
                <li class="d-flex align-items-center">
                  ...
                  <div class="text">
                    <h5 class="mb-0"> <a href="../blog-post.php">Blog 1</a></h5>
                  </div>
                </li>
                <li class="d-flex align-items-center">
                  <div class="image"><img src="img/detailsquare.jpg" alt="..." class="img-fluid"></div>
                  <div class="text">
                    <h5 class="mb-0"> <a href="../blog-post.php">Blog 2</a></h5>
                  </div>
                </li>
                <li class="d-flex align-items-center">
                  <div class="image"><img src="img/detailsquare.jpg" alt="..." class="img-fluid"></div>
                  <div class="text">
                    <h5 class="mb-0"> <a href="../blog-post.php">Blog 3</a></h5>
                  </div>
                </li>
              </ul>
              <hr class="d-block d-lg-none">
            ...
            <div class="col-lg-3">
              ...
              <p class="text-uppercase"><strong>Universal Ltd.</strong><br>13/25 New Avenue <br>GHazela esprit <br>45Y 73J <br>Tunisia<br><strong></strong></p><a href="../contact.php" class="btn btn-template-main">Go to contact page</a>
              <hr class="d-block d-lg-none">
            </div>
            <div class="col-lg-3">
          ...
          <div class="container">
            <div class="row">
              <div class="col-lg-4 text-center-md">
                <p>&copy; 2021 WebdEv / Ani'mall</p>
              </div>
              <div class="col-lg-8 text-right text-center-md">
                <p>Website designed by <a href="https://bootstrapious.com/snippets">WebDev</a>&  <a href="https://fity.cz/">Ani'mall team</a></p>
