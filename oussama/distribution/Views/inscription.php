<?php
    ...
    if (
        ...
        // Badel el lien leli theb yemchilou baad el inscription
        ...
        <div class="container">
            <div class="row d-flex align-items-center">
                <div class="col-md-6 d-md-block d-none">
                    <p>Contact us on +420 777 555 333 or @universal.com.</p>
                </div>
                <div class="col-md-6">
    ...
    <header class="nav-holder make-sticky">
        <div id="navbar" role="navigation" class="navbar navbar-expand-lg">
            <div class="container"><a href="index.html" class="navbar-brand home"><img src="img/logo.png"
                            ...
                            src="img/logo-small.png" alt="Universal logo" class="d-inline-block d-md-none"><span
                    ...
                    <ul class="nav navbar-nav ml-auto">
                        <li class="nav-item dropdown active"><a href="javascript: void(0)" data-toggle="dropdown"
                            ...
                            <ul class="dropdown-menu">
                                <li class="dropdown-item"><a href="index.html" class="nav-link">Option 1: Default
                                        Page</a></li>
                                <li class="dropdown-item"><a href="index2.html" class="nav-link">Option 2:
                                        Application</a></li>
                                <li class="dropdown-item"><a href="index3.html" class="nav-link">Option 3: Startup</a>
                                </li>
                                <li class="dropdown-item"><a href="index4.html" class="nav-link">Option 4: Agency</a>
                                </li>
                                <li class="dropdown-item dropdown-submenu"><a id="navbarDropdownMenuLink2" href="#"
                                    ...
                                    <ul aria-labelledby="navbarDropdownMenuLink2" class="dropdown-menu">
                                        ...
                                        <li class="dropdown-item"><a href="#" class="nav-link">Something else here</a>
                                        </li>
                                    </ul>
                                </li>
                            </ul>
                        ...
                        <li class="nav-item dropdown menu-large"><a href="#" data-toggle="dropdown"
                                                                    class="dropdown-toggle">Features<b
                                        class="caret"></b></a>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-3 col-md-6">
                                            ...
                                            <ul class="list-unstyled mb-3">
                                                ...
                                                <li class="nav-item"><a href="template-alerts.html" class="nav-link">Alerts</a>
                                                </li>
                                                <li class="nav-item"><a href="template-buttons.html" class="nav-link">Buttons</a>
                                                </li>
                                                <li class="nav-item"><a href="template-content-boxes.html"
                                                                        class="nav-link">Content boxes</a></li>
                                        ...
                                        <div class="col-lg-3 col-md-6">
                                            ...
                                            <ul class="list-unstyled mb-3">
                                                ...
                                                <li class="nav-item"><a href="template-header-light.html"
                                                                        class="nav-link">Light header</a></li>
                                            </ul>
                                        </div>
                                    </div>
                                </li>
                        ...
                        <li class="nav-item dropdown menu-large"><a href="#" data-toggle="dropdown"
                                                                    class="dropdown-toggle">Portfolio <b
                                        class="caret"></b></a>
                            <ul class="dropdown-menu megamenu">
                                <li>
                                    <div class="row">
                                        ...
                                        <div class="col-lg-3 col-md-6">
                                            ...
                                            <ul class="list-unstyled mb-3">
                                                ...
                                                <li class="nav-item"><a href="team.html" class="nav-link">Our team</a>
                                                </li>
                        ...
                        <li class="nav-item dropdown menu-large"><a href="#" data-toggle="dropdown"
                                                                    ...
                                                                    class="dropdown-toggle">All Pages <b
                                        class="caret"></b></a>
                            <ul class="dropdown-menu megamenu">
                                <li>
                                    <div class="row">
                                        <div class="col-md-6 col-lg-3">
                                            <h5>Home</h5>
                                            <ul class="list-unstyled mb-3">
                                                <li class="nav-item"><a href="index.html" class="nav-link">Option 1:
                                                        Default Page</a></li>
                        ...
                        <li class="nav-item dropdown"><a href="javascript: void(0)" data-toggle="dropdown"
                            ...
                            <ul class="dropdown-menu">
                                <li class="dropdown-item"><a href="contact.html" class="nav-link">Contact option 1</a>
                                </li>
                                <li class="dropdown-item"><a href="contact2.html" class="nav-link">Contact option 2</a>
                                </li>
                                <li class="dropdown-item"><a href="contact3.html" class="nav-link">Contact option 3</a>
                                </li>
                            </ul>
                        </li>
                            ...
                            <table border="1" align="center">
                                ...
                                <center>
                                    <div class="form-floating mb-3">
                                        <label for="user id">CIN:
                                        </label>
                                        <input type="number" name="iduser" min="9999999" max="99999999" placeholder="00000000">
                                    </div>

                                    <div class="form-floating mb-3">
                                        <label for="nom">nom:
                                        </label>
                                        <input type="text" name="nom" maxlength="100" placeholder="Nom">
                                    </div>

                                    <div class="form-floating mb-3">
                                        <label for="mail">mail:
                                        </label>
                                        <input type="email" name="mail" maxlength="100" placeholder="name@example.com">
                                    </div>

                                    <div class="form-floating mb-3">
                                        <label for="pass">pass:
                                        </label>
                                        <input type="password" name="pass" minlength="6" placeholder="***********">
                                    </div>
                    </div>
                    <div>
                        <td>
