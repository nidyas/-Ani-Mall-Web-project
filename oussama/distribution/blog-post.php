...
<html>
  ...
  <body>
          ...
          <div class="row bar">
            ...
            <div id="blog-post" class="col-md-9">
              ...
              <div id="post-content">
                ...
                <h2>Blog 1 </h2>
                <ol>
                  <li>it is really nice to buy a dog</li>
              ...
              <div id="comments">
                ...
                <?php include "View/load_comments.php";
                ?>
              ...
              <div id="comment-form">
                ...
                <form action="View/add_comment.php " method="GET" id ="form">
                  <div class="row">
                    <div class="col-sm-6">
                      <div class="form-group">
                        ...
                        <input id="name" name="nom" type="text" class="form-control"required>
                      </div>
                    </div>
                  </div>
                  <div class="row">
                    <div class="col-sm-6">
                      <div class="form-group">
                        ...
                        <input id="email" name="mail" type="text" class="form-control" onkeydown="onkey()">
                      </div>
                    </div>
                  </div>
                   <div class="row">
                    <div class="col-sm-6">
                      <div class="form-group">
                        <label for="email">Location<span class="required text-primary">*</span></label>
                        <span id ="erroradr"></span>
                  ...
                  <div class="row">
                    <div class="col-sm-12 text-right">
                      <button type="submit" class="btn btn-template-outlined"  onclick="connect()"><i class="fa fa-comment-o"></i> Post comment</button>
                    </div>
                  </div>
                </form>
              </div>
            ...
            <div class="col-md-3">
              <div class="panel panel-default sidebar-menu">
                <div class="panel-heading">
                  <h3 class="h4 panel-title">Feel Lost?</h3>
                </div>
                <div class="panel-body text-widget">
                  <p> try search button if you'r lost </p>
                </div>
              </div>
              <div class="panel panel-default sidebar-menu">
                <div class="panel-heading">
              ...
              <div class="panel panel-default sidebar-menu">
                ...
                <div class="panel-body">
                  <ul class="nav nav-pills flex-column text-sm">
                    <li class="nav-item"><a href="blog.html" class="nav-link">DOGS</a></li>
                    <li class="nav-item"><a href="blog.html" class="nav-link active">CATS</a></li>
                    <li class="nav-item"><a href="blog.html" class="nav-link">BIRDS</a></li>
                  </ul>
                </div>
              </div>
      ...
      <div class="get-it">
        <div class="container">
          <div class="row">
            ...
            <div class="col-lg-4 text-center p-3">   <a href="file:///C:/xampp/htdocs/universal-2-1-0/distribution/contact2.html" class="btn btn-template-outlined-white">Contact</a></div>
          </div>
        </div>
      </div>
      <!-- FOOTER -->
        ...
        <div class="container">
          <div class="row">
            ...
            <div class="col-lg-3">
              ...
              <p class="text-uppercase"><strong>Ani'mall</strong><br>13/25 Aouina  <br>Esprit Center<br>2045 <br>Tunisia <br><strong>GHazela</strong></p><a href="contact.html" class="btn btn-template-main">Go to contact page</a>
              <hr class="d-block d-lg-none">
            </div>
            <div class="col-lg-3">
          ...
          <div class="container">
            <div class="row">
              <div class="col-lg-4 text-center-md">
                <p>&copy; 2021 WeDev / Ani'mall</p>
              </div>
              <div class="col-lg-8 text-right text-center-md">
                <p>Template design by <a href="https://bootstrapious.com/snippets">WeDevv </a></p>
    ...
    <script src="js/CScomment.js"></script>
  </body>
</html>