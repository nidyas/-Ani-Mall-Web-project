  ...
  <div class="topnav" id="myTopnav">
    ...
    <?php if(isset($_SESSION['login'])) { ?>
      <?php if($_SESSION['login']['access_level'] == 'Administrator') { ?>
        <a href="./display_all.php">update Animals</a>
		 <a href="./insert_form.php">add Animals</a>
		  <a href="./update_user.php">update users</a>
		  <a href="./update_commands.php">update Commandes</a>
      <?php } ?>
